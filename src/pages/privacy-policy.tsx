export default function PrivacyPolicy() {
	return (
		<>
			<div className="w-full px-6 mx-auto heading-sizes mb-4 max-w-3xl">
				<h1>Privacy Policy</h1>
				<p>
					<strong>Last updated April 30, 2020</strong>
				</p>
				<p>
					Thank you for choosing to be part of our community at Camelot Inc. (“
					...
					to your personal information, please contact us at staff@camelot.fm.
				</p>
				<p>
					...
					use of our Apps and our services.
				</p>
				<p>
					This privacy policy applies to all information collected through our
					mobile application, ("<strong>Apps</strong>"), and/or any related
				...
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#infocollect">
						1. WHAT INFORMATION DO WE COLLECT?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#infouse">
						2. HOW DO WE USE YOUR INFORMATION?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#infoshare">
						3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#sociallogins">
						4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#inforetain">
						5. HOW LONG DO WE KEEP YOUR INFORMATION?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#infosafe">
						6. HOW DO WE KEEP YOUR INFORMATION SAFE?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#privacyrights">
						7. WHAT ARE YOUR PRIVACY RIGHTS?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#databreach">
						8. DATA BREACH
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#DNT">
						9. CONTROLS FOR DO-NOT-TRACK FEATURES
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#caresidents">
						10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#policyupdates">
						11. DO WE MAKE UPDATES TO THIS POLICY?
					</a>
				</p>
				<p>
					<a href="https://app.termly.io/dashboard/website/373620/privacy-policy#contact">
				...
				<p>
					...
					in activities on the Apps (such as posting messages in our online
				...
				<p>
					...
					first name, maiden name, last name, and nickname; email addresses;
					social media; and other similar data.
				</p>
				<p>
					<strong>Personal Information Provided by You.</strong> We collect app
					usage; passwords; and other similar data.
				</p>
				<p>
				...
				<p>
					<strong>Online Identifiers.</strong> We collect devices; applications;
					tools and protocols, such as IP (Internet Protocol) addresses; cookie
				...
				<p>
					...
					source of information and the type of information and the type of
					...
					<li>
						<blockquote>
							<p>
								...
								promotional campaigns and to evaluate and improve our Apps,
				...
				<p>
					...
					distributed outside the Apps in perpetuity. If you interact with other
					users of our Apps and register through a social network (such as
				...
				<p>
					...
					you on the Apps. Please note that we do not control, and are not
				...
				<p>
					...
					information to and from our Apps is at your own risk. You should only
				...
				<p>
					...
					email us at EMAIL ADDRESS HERE.
				</p>
				<p>
				...
				<p>
					...
					will be notified about data breaches when Camelot Inc. believes you
					...
					mental or physical well-being. In the event that Camelot Inc. becomes
					aware of a security breach which has resulted or may result in
					unauthorized access, use or disclosure of personal information Camelot
					Inc. will promptly investigate the matter and notify the applicable
				...
				<p>
					...
					at <a href="mailto:staff@camelot.fm">staff@camelot.fm</a> or by post
					to:
				</p>
				<p>Camelot Inc.</p>
				<p>2811 East Pennwood Circle</p>
				<p>Green Bay, WI 54301</p>
				<p>United States</p>
				<p>
					<strong>
				...
				<p>
					...
					to staff@camelot.fm. We will respond to your request within 30 days.
				</p>
			</div>
		</>
	)
