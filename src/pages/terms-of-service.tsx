	...
	return (
		<>
			<div className="w-full px-6 mx-auto heading-sizes mb-4 max-w-3xl">
				...
				<p>
					<strong>Last Updated 24 June 2020</strong>
				</p>
				<h2>1. Agreement to Terms</h2>
				<p>
					1.1 These Terms and Conditions constitute a legally binding agreement
					made between you, whether personally or on behalf of an entity (
					<strong>you</strong>), and <strong>Camelot Inc.</strong>, located at{' '}
					<strong>
						2811 East Pennwood Circle, Green Bay, WI 54301 United States
					</strong>{' '}
					(<strong>we</strong>, <strong>us</strong>), concerning your access to
					and use of the <strong>Camelot (CAMELOT.FM)</strong> website as well
					as any related applications (the <strong>Site</strong>).
				</p>
				<p>
					The Site provides the following services:{' '}
					<strong>
						Camelot is a social habit builder that builds communities of people
						developing similar habits.
					</strong>{' '}
					(<strong>Services</strong>). You agree that by accessing the Site
				...
				<p>
					1.6 The Site is intended for users who are at least 13 years old. If
					you are under the age of 13, you are not permitted to register for the
				...
				<blockquote>
					<p>
						Our <a href="/privacy-policy">Privacy Notice</a>, which sets out the
				...
				<p>
					...
					password you must promptly notify us at camelot email.
				</p>
				<p>
				...
				<p>
					...
					providers (each such account, a <strong>Third Party Account</strong>)
				...
				<p>
					...
					Account (the “<strong>Social Network Content</strong>”) so that it is
					available on and through the Site via your account, including without
					limitation any friend lists; and (b) we may submit and receive
					additional information to your Third Party Account to the extent you
				...
				<p>
					...
					registered to use the Site. At your email request to camelot email or
					through your account settings (if applicable), we will deactivate the
					connection between the Site and your Third Party Account and attempt
				...
				<p>
					...
					please contact us at camelot email or use the take down or report
					button.
				</p>
				<h2>5. Our content</h2>
				<p>
				...
				<p>
					...
					modifications, adaptations, additions or enhancements to the Site or
					Our Content, including the modification of the paper or digital copies
				...
				<h2>7. Modifications to and availability of the Site</h2>
				<p>
				...
				<ul>
					...
					<li>
						...
						amount paid, if any, by you to us for the Services/Site during the
				...
				<p>
					...
					by contacting us at camelot email.
				</p>
				<p>
				...
				<p>
					...
					<em>
						...
						European Union, you have certain rights to decompile the Software
						if:
					</em>
				</p>
				<ul>
					<li>
						this is necessary to obtain the information that you need to make
						the software interoperable with other software and
					</li>
					<li>we have not made that information available to you.</li>
				</ul>
				<p>
					<em>
						Before reverse engineering or decompiling the software, you must
						first write to us and ask us to provide you with the
						interoperability information that you need. Please provide us with
						full details of your requirements so that we can assess what
						information you need. We may impose reasonable conditions on
						providing you with interoperability information. You must use that
						information only for the purpose of making the software
						interoperable with other software. You must not use that information
				...
				<p>
					11.8{' '}
					<em>
						<strong>For consumers only</strong> - Please note that these Terms
				...
				<p>
					...
					contact us by email at camelot email or by post to:
				</p>
				<p>Camelot Inc.</p>
