					...
					<div style={{ maxWidth: '1200px', margin: '0 auto' }}>
								...
								>
									...
									<div className="text-sm text-center">
										...
										<div
											...
											onClick={() =>
												CopyInviteLink(data, setNotificationMessage)
											}
										>
						...
						<div className="flex flex-col w-full px-6 xl:flex-row">
							<div className="w-full">
								...
								<div
									id="walkthrough_pot"
									className="px-8 pt-5 pb-8 -card --shadow"
								>
									...
									<div className="flex flex-col mt-8 -hstack md:flex-row">
										<div className="relative p-6 border-b">
											<div className="flex text-sm">
												...
												<div className="ml-auto has-tooltip">
													<span
														className="max-w-xs p-1 mt-6 text-black bg-gray-100 rounded shadow-lg tooltip"
														style={{ right: 0 }}
													>
														This is the amount of times your group has checked
														in with photo evidence they've completed the weekly
														activity this month.
													</span>
													<span className="cursor-pointer">
											...
											<div className="flex text-sm">
												...
												<div className="ml-auto has-tooltip">
													<span
														...
														style={{ right: 0 }}
													>
														This is your groups streak. It increases every time
														all members in your group complete their check ins
											...
											<div className="flex text-sm">
												...
												<div className="ml-auto has-tooltip">
													<span
														...
														style={{ right: 0 }}
													>
														This is the amount of times group members have paid
														in their swear jar fee to the group pot by failing
														to check in by Sunday at midnight.
													</span>
													<span className="cursor-pointer">
														<img src="/img/question-mark.svg" width="10" />
													</span>
