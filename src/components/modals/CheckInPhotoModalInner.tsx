...
export function CheckInPhotoModalInner({ closeModal, potId, openSuccessModal }: ModalProps) {
	...
	return (
		<div className="flex flex-col h-full justify-evenly">
            ...
            <p style={{color: "#808191"}}>Drag and Drop to enter photo select from files</p>			
			<div
			...
			<div>
				<button
                    ...
                    onClick={() => {
                        // checkinMutation.mutate(acceptedFiles[0])
                        closeModal();
                        openSuccessModal();
                    }}
				>
